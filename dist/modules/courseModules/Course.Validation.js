...
const createCourseSchemaValidation = zod_1.z.object({
    ...
    categoryId: zod_1.z.string(), // Assuming category ID is a string; update if needed
...
const updateCourseSchemaValidation = zod_1.z.object({
    ...
    categoryId: zod_1.z.string().optional(), // Assuming category ID is a string; update if needed
